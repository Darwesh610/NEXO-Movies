...
useEffect(() => {
  getData()
    ...
    return  <> <div className='row my-5 px-5 g-5'>
        {data.length > 0 ? data.map((movie , indx) => <div key={indx} className="col-md-4">
        <Link className='link' to={`/trendingdetails/${indx}`}><div className='card-movie'>
        ...
        <button id={`keyTrending${indx}`} className='butt' onClick={() => increase(movie , indx , 'Trending')}><i className="fa-solid fa-heart"></i>Favorite</button>
        </div>
